<?php
	...
	class Color_texto
	{
		...
		private $fondo=array("mostaza" =>33,
							"negro"=>40,
							 "rojo"=>41,
 							 "verde"=>42,
							 "naranja"=>43,
		...
		public function txtcolor($string,$estilo=null,$txtcolor=null,$fondocolor=null)
		{
			...
			elseif (isset($this->fondo[$fondocolor]) or !isset($fondocolor)) {
				$color_string.="40m";
			}
			else
			{
		...
		public function Estilos()
		{
			...
			echo  " [#]  7  Color mostaza -->\"\033[7m Texto invicible\033[0m\"\n";
